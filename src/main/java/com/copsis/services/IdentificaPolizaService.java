...
public class IdentificaPolizaService {
	...
	public EstructuraJsonModel queIndentificaPoliza(PdfForm pdfForm, HttpHeaders headers) throws IOException {
		...
		try {
			...
			if (encontro == false) {
				if (contenido.contains("visite gnp.com.mx") || contenido.contains("GNP")
			...
			// ENTRADA PARA AXA
			if (encontro == false) {
				if (contenido.contains("AXA Seguros, S.A. de C.V.") || contenido.contains("AXA SEGUROS, S.A. DE C.V")
			...
			// ENTRADA PARA ATLAS
			if (encontro == false) {
				if (contenido.contains("Atlas") || contenido.contains("Atlas, S.A.")
			...
			if (encontro == false) {
				if ((contenido.contains("ANA COMPAÑÍA DE SEGUROS") && contenido.contains("www.anaseguros.com.mx"))
						...
						|| (contenido.contains("A.N.A. Compañía de Seguros")
								&& contenido.contains("www.anaseguros.com.mx"))
