...
import com.copsis.models.impresionCaractula.ImpresionCaractulaVida;
...
public class ImpresionService {
    ...
    public byte[] impresionCaractulaPrudential(CaractulaProjection  caractulaProjection){
     ...
     public byte[] impresionMovimiento(MovimientosForm movimientosForm) {
      ...
      public byte[] impresionCaractulaVida(ImpresionCaractulaForm  impresionCaractulaForm){
        try {
            byte[] byteArrayPDF = null;
            byteArrayPDF = new ImpresionCaractulaVida().buildPDF(impresionCaractulaForm);
            return byteArrayPDF;
        }
        catch (ValidationServiceException e) {
            throw e;
