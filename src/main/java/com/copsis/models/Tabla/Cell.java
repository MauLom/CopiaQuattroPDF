...
public class Cell <T extends PDPage> {
	 private float width;
	    ...
	    // default border
	    private LineStyle leftBorderStyle = new LineStyle(new Color(229, 234, 237), 0);
	    private LineStyle rightBorderStyle = new LineStyle(new Color(229, 234, 237), 0);
	    private LineStyle topBorderStyle = new LineStyle(new Color(229, 234, 237), 0);
	    private LineStyle bottomBorderStyle = new LineStyle(new Color(229, 234, 237), 0);
	    ...
	    /**
	     * <p>
	     * Constructs a cell with the default alignment {@link VerticalAlignment#TOP}
	     ...
	     * @param width absolute width in points or in % of table width (depending
	     * on the parameter {@code isCalculated})
	     * @param text The text content of the cell
	     * @param isCalculated If {@code true}, the width is interpreted in % to the
	     * table width
	    ...
	    public void setHorizontalFreeSpace(float dato) {
	         this.horizontalFreeSpace = dato;
	    }
	    
	    public float getHorizontalFreeSpace1() {
	       
	            return this.horizontalFreeSpace;
	     ...
	     * </p>
	     *
	     * @param sourceCell Source {@link Cell} from which cell style will be
	     * copied.
	     */
	     ...
	     * </p>
	     *
	     * @param sourceCell Source {@link Cell} which will be used for style
	     * comparation
