...
public class PDocumenteHW  implements COSObjectable{
    ...
    public static final PDRectangle B0 = new PDRectangle(230 * POINTS_PER_MM, 297 * POINTS_PER_MM);
    
    
    /**  A rectangle the size of A0 Paper. */
    public static final PDRectangle A0 = new PDRectangle(841 * POINTS_PER_MM, 1400 * POINTS_PER_MM);
    ...
    public static final PDRectangle A6 = new PDRectangle(105 * POINTS_PER_MM, 148 * POINTS_PER_MM);
      ...
      /**  A rectangle the size of A6 Paper. */
    public static final PDRectangle A7 = new PDRectangle(86 * POINTS_PER_MM, 109 * POINTS_PER_MM);
    
    /*Tamaño Carta pero es  landscape*/
    public static final PDRectangle A8 = new PDRectangle(11f * POINTS_PER_INCH, 8.5f *POINTS_PER_INCH);
     ...
     */
    public PDocumenteHW( float width, float height )
    {
     ...
     * @param height The height of the rectangle.
     */
    public PDocumenteHW( float x, float y, float width, float height )
    {
     ...
     */
    public PDocumenteHW( BoundingBox box )
    {
        rectArray = new COSArray();
     ...
     */
    public PDocumenteHW( COSArray array )
    {
