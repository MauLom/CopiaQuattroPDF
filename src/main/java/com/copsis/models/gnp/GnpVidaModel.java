							...
							if (dato.split("###")[0].contains("Vida")) {
								if (dato.split("###")[0].split("Vida").length == 3) {
									if (dato.split("###")[0].split("Vida")[2].contains("Póliza")) {
										modelo.setPlan("Vida "
												+ dato.split("###")[0].split("Vida")[2].split("Póliza")[0].trim());
									}
								}
						...
						for (int i = 0; i < newcontenido.split("@@@")[(donde + 1)].split("\r\n").length; i++) {
							if (newcontenido.split("@@@")[(donde + 1)].split("\r\n")[i].contains("C ontratante")) {
								if ((i + 2) < newcontenido.split("@@@")[(donde + 1)].split("\r\n").length
										&& newcontenido.split("@@@")[(donde + 1)].split("\r\n")[(i + 2)].trim()
												.split("###").length == 1) {
						...
						if (i == 4) {
							if (newcontenido.split("@@@")[donde].split("\r\n")[i].split("###").length == 6
								...
								if (resultado.contains("el")) {
									...
									modelo.setVigenciaA(fn.formatDate(resultado.split("el")[1].replace("/", "-").trim(),
											"dd-MM-yy"));
								}
							}
						}
					...
					for (int i = 0; i < newcontenido.split("@@@")[(donde - 1)].split("\r\n").length; i++) {
						...
						if (newcontenido.split("@@@")[(donde - 1)].split("\r\n")[i].split("###").length == 6
							...
							if (resultado.contains("el")) {
								...
								modelo.setVigenciaA(
										fn.formatDate(resultado.split("el")[1].replace("/", "-").trim(), "dd-MM-yy"));
							}
						}
