...
public class BanorteVidaModel {
	...
	public EstructuraJsonModel procesar() {
		...
		try {
			...
			fin = contenido.indexOf(ConstantsValue.COBERTURAS_SUMAS_ASEGURADAS);
			...
			modelo.setError(BanorteVidaModel.this.getClass().getTypeName() + " - catch:" + ex.getMessage() + " | "
					+ ex.getCause());
			return modelo;
		}
	}
