				...
				try {
	                    ...
	                    if (impresionAxa.getAsegurados() != null) {
	                        while (t1 < impresionAxa.getAsegurados().size()) {
	                            ...
	                            communsPdf.setCell(baseRow, 12, impresionAxa.getAsegurados().get(t1).getParentesco(), Color.BLACK, false, "C", 9, communsPdf.setLineStyle(Color.white), "", communsPdf.setPadding(5f, 5f, 3f, 5f), bgColor);
	                            communsPdf.setCell(baseRow, 19, impresionAxa.getAsegurados().get(t1).getFechNacimiento(), Color.BLACK, false, "C", 9, communsPdf.setLineStyle(Color.white), "", communsPdf.setPadding(5f, 5f, 3f, 5f), bgColor);
