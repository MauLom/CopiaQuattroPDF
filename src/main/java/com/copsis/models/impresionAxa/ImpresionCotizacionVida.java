					...
					if (cotizacionProjection.isVida()) {
						...
						for (TextoAxa textoAxa : texto) {
							...
							if (i == 2) {
								...
								communsPdf.setCell(baseRow3, 85, Sio4CommunsPdf.eliminaHtmlTags3(textoAxa.getTexto()+" "+cotizacionProjection.getSumaAseguradaMenor()), Color.BLACK, false, "C", 12, communsPdf.setLineStyle(Color.BLACK), "", communsPdf.setPadding(5f, 5f, 3f, 5f), bgColor);
							} else {
								baseRow3 = communsPdf.setRow(table3, 25);
								communsPdf.setCell(baseRow3, 85, Sio4CommunsPdf.eliminaHtmlTags3(textoAxa.getTexto()+" "+cotizacionProjection.getSumaAseguradaTitular()), Color.BLACK, false, "C", 12, communsPdf.setLineStyle(Color.BLACK), "", communsPdf.setPadding(5f, 5f, 3f, 5f), bgColor);
							}
