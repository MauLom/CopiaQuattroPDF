              ...
              ByteArrayOutputStream output;
                try ( PDDocument document = new PDDocument()) {
                    try {
                        ...
                        communsPdf.setCell(baseRow, 50, datos.getFechaDesde(), Color.black, false, "C", 10, communsPdf.setLineStyle(Color.black), "", communsPdf.setPadding2(4f, 0f, 2f, 0f),Color.white).setValign(VerticalAlignment.MIDDLE);
                        communsPdf.setCell(baseRow, 50, datos.getFechaHasta(), Color.black, false, "C", 10, communsPdf.setLineStyle(Color.black), "", communsPdf.setPadding2(4f, 0f, 2f, 0f),Color.white).setValign(VerticalAlignment.MIDDLE);                   
                        table.draw();
