        ...
        try {
            try (PDDocument document = new PDDocument()) {
                try {
                    ...
                    communsPdf.setCell(baseRow, 100,"", Color.black, false, "L", 10, communsPdf.setLineStyle(bgColorA,bgColorA,bgColorA,bgColorA), "", communsPdf.setPadding(4f, 4f, 4f, 4f), bgColor);
                    table.draw();
                }
