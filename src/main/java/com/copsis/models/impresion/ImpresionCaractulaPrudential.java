                    ...
                    for (int i = 0; i < cbo.size();i++){ 
                        ccb++;
                         ...
                         if(ccb == cbo.size()) {                           
                            ...
                            communsPdf.setCell(baseRow, 63, ( datos.getPaquete() == 2 || datos.getPaquete() == 4  ? datos.getSumaAsegurada() : cbo.get(i).getSa()), Color.BLACK, false, "C", 10, communsPdf.setLineStyle(Color.black, Color.white, Color.black, Color.black), "", communsPdf.setPadding2(5f, 0f, 3f, 0f), Color.white);                       
                         }else{
                            baseRow = communsPdf.setRow(table);
                            ...
                            communsPdf.setCell(baseRow, 63,( datos.getPaquete() == 2 || datos.getPaquete() == 4  ? datos.getSumaAsegurada() : cbo.get(i).getSa()), Color.BLACK, false, "C", 10, communsPdf.setLineStyle(Color.black, Color.white, Color.white, Color.black), "", communsPdf.setPadding2(5f, 0f, 3f, 0f), Color.white);
